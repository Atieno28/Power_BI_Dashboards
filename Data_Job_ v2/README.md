...
![Dashboard Page 1](/Images/Project%202%20Page%201.JPG)
## Introduction

Information about the data job market is scattered and hard to grasp. This dashboard (V2.0) is created for **Job seekers, Job Transitioners, and Job Swappers** to cut through the clutter. Using a *real-world dataset of 2024 data science job postings* (including titles, salaries, and locations), this project provides a streamlined, single page , easy-to use interface to explore market trends and compensation insights.
